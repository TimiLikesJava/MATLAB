function breakout(init)

% The code below has sample code from the breakout file exchange on the
% MathWorks website. I personally adjusted the function's GUI controls such
% as the figure , axes , and components for the test cases such as NewGame,
% start, and movePaddle

if ~nargin
    init = 'start';
end
if ~(ischar(init)||isscalar(init))
    return;
end
...
switch init
    ...
    case {49 50 51 52 53 54 55 56 57}
        Speed = 35+(init-52)*5;
        set(hSpeed,'String',['Speed \color[rgb]{.4 0 0}' repmat('|',1,init-48)])
end
end
